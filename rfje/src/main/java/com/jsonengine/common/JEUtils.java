...
public class JEUtils {
	...
	// This may be better to use their appid
    ...
    public Set<String> extractTerms(String text) {
        ...
        //final String result = callURL(YAHOO_PARSE_JA + text); //asif: commented for illegal argument exception
        final String result = callYahooAPI (text); //asif: instead using this new method. see: http://d.hatena.ne.jp/TsutomuUchima/20110210/p1
